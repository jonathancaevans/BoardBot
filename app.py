...
def export():
    ...
    try:
        r = requests.post(
            ...
            json={"username": kilterboarduser, "password": kilterboardpass},
        )
        ...
        frames_count = 1
        frames_pace = 0
        placements = request.json["placements"]
        ...
        ascent = {
            ...
            "attempt_id": 1,
            "quality": 3,
            "difficulty": request.json["gradeIndex"],
            "is_benchmark": False,
            "comment": "BoardGAN's autograder rates this a "
            + request.json["gradeLabel"],
            "climbed_at": datetime.utcnow().strftime("%Y-%m-%d %H:%M:%S.%f"),
        }
        ...
        r = requests.put(
            "https://api.kilterboardapp.com/v1/climbs/" + uuid,
            headers=headers,
            json=newClimb,
        )
        r = requests.put(
            "https://api.kilterboardapp.com/v1/ascents/" + ascent["uuid"],
            json=ascent,
            headers=headers,
        )
            ...
            "query": {
                ...
                "syncs": {
                    "shared_syncs": [
                        {
                            "table_name": "climbs",
                            "last_synchronized_at": "2018-3-27 15:45:25.021411",
                        }
                    ]
                },
            }
